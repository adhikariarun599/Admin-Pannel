    ...
    snap.forEach(doc => {
        ...
        tbody.innerHTML += `
            <tr>
                ...
                <td>
                    ${d.proofImage ? `<img src="${d.proofImage}" style="width:50px; height:50px; object-fit:cover; border-radius:4px; cursor:pointer; border:1px solid #cbd5e1;" onclick="window.open('${d.proofImage}')">` : 'No Image'}
                </td>
                <td>
